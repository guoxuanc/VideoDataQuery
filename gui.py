...
class VideoQueryGUI(ttk.Frame):
    ...
    def create_frames(self):
        ...
        self.match_list.grid(row=0, column=1, rowspan=2, sticky='wens')
        ...
        self.status_label.grid(row=0, column=0, sticky='nswe', columnspan=2)

        self.middle_frame.grid_columnconfigure(0, weight=1)
        self.middle_frame.grid_columnconfigure(1, weight=1)

        self.query_player = VideoPlayer(self.middle_frame)
        self.query_player.grid(row=1, column=0, sticky='nsw')
        self.db_player = VideoPlayer(self.middle_frame)
        self.db_player.grid(row=1, column=1, sticky='nse')
        ...
        self.match_info_label.grid(row=0, column=0, sticky='nswe')

        image = cv2.imread("/Users/ChangGuoxuan/desktop/VideoQuery/graph_place_holder.png")
        width = 365
        height = 280
        dim = (width, height)
        ...
        self.panelA.grid(row=0, column=1, sticky='nse', padx=0, pady=0)
    ...
    def run_match(self):
        ...
        display_plot(self.final_ranks, "graph", "/Users/ChangGuoxuan/desktop/VideoQuery/graph")
        #generate_plots(self.final_ranks, "temp", "/Users/ChangGuoxuan/desktop/VideoQuery/temp")
        ...
        image = cv2.imread("/Users/ChangGuoxuan/desktop/VideoQuery/graph_final.png")
        width = 365
        height = 280
        dim = (width, height)
        image = cv2.resize(image, dim, interpolation = cv2.INTER_AREA)
